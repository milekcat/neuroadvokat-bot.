...
async def order_action(query, context):
    ...
    await context.bot.send_message(
        chat_id=user_id,
        text=r"Отлично\! *Пожалуйста, представьтесь* и опишите вашу ситуацию\. Вы можете присылать текст, фото, документы и голосовые сообщения\. Когда закончите, нажмите кнопку ниже\.",
